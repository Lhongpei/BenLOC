...
path = ['repo/datasets/indset/labels/indset_table_dataset.csv', 'repo/datasets/setcover/labels/setcover_table_dataset.csv']
print(os.getcwd())
...
if not os.path.exists('repo/datasets/balanced_set_ind/labels/kfold'):
    os.makedirs('repo/datasets/balanced_set_ind/labels/kfold')
...
for t in range(1,fold+1):
    ...
    train_df.to_csv('repo/datasets/balanced_set_ind/labels/kfold'+f'/fold_{t}_train.csv')
    val_df.to_csv('repo/datasets/balanced_set_ind/labels/kfold'+f'/fold_{t}_val.csv')
    test_df.to_csv('repo/datasets/balanced_set_ind/labels/kfold'+f'/fold_{t}_test.csv')