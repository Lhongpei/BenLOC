...
from BenLOC.DL.gnn_pairwise.dataset_gen.graphDataset import mipGraphDataset, mipGraphN2N
from .vae_models import Decoder, Encoder
...
if __name__ == '__main__':
    ...
    pathConfig = create_config(repo_path)
    ...
    benchmark = 'setcover'
    file_path = './mix_set_ind'
    print('file_num:',len(os.listdir(file_path)))
    ...
    train_folder = f'{benchmark}_vae_train'
    ...
    dataset = mipGraphN2N(root=file_path, max_num = 1e5)
