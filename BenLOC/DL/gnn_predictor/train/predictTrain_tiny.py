...
from BenLOC.DL.gnn_predictor.dataset_gen.predictDataset import (RankListSolTimeDataset,
                                            RegrSolTimeDataset,
                                            RegrSolTimeDatasetTiny)
from BenLOC.DL.gnn_predictor.models.tasks import RankListNet, RegrNet
from BenLOC.DL.gnn_predictor.models.vae_models import Encoder
from BenLOC.DL.gnn_predictor.train.trainer import RankListTrainer, RegrTrainer
...
if __name__ == '__main__':
    ...
    modeGNN = 'GIN' #FIXME: change to 'GCN' if you want to use GCN, change to 'GIN' if you want to use GIN
    ...
    if use_wandb:
        wandb.init(
            ...
            name = f'lr_{lr},stepsize_{stepsize},gamma_{gamma}',
    ...
    dataset = RegrSolTimeDatasetTiny
    test_dataset = RegrSolTimeDatasetTiny(root=file_path, fold=fold, report_file_root=report_file_root, type='test', report_norm=None, reprocess=reproData, pro_num=select_pro_num, config_num=select_config_num)
